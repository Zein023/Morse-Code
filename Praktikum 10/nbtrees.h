...
typedef struct { 
    infotype info;     // Isi data, tipe char
    address ps_fs;     // Alamat anak pertama (first son)
    address ps_nb;     // Alamat saudara kandung (next brother)
    address ps_pr;     // Alamat parent
} nbtree;
